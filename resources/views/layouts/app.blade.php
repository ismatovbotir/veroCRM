...
<body>
  ...
  <div class="container-fluid border-bottom px-4">
      ...
      <div class="container">
        ...
        <form class="d-flex" role="search" method="POST" action="{{route('item.search')}}">
          @csrf
          <div class="input-group mb-3 pt-3">
            <input type="text" class="form-control" placeholder="Barcode" aria-label="Recipient's username" name="barcode" autofocus>
            <button class="btn btn-outline-secondary" type="submit" id="button-addon2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-upc-scan" viewBox="0 0 16 16">
  ...
  <div class="container-fluid px-4">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-0">
        <li class="breadcrumb-item"><a href="{{route('main.index')}}">Main</a>
        </li>
        <li class="breadcrumb-item active"><span>Item</span>
        </li>
      </ol>
    </nav>
  </div>
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="card" style="--cui-card-cap-bg: #3b5998">
              <div class="card-header position-relative d-flex justify-content-center align-items-center">
                <svg class="icon icon-3xl text-white my-4">
                  <use xlink:href="{{asset('ode_modules/@coreui/icons/sprites/brand.svg#cib-facebook-f')}}"></use>
                </svg>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="card" style="--cui-card-cap-bg: #4875b4">
              <div class="card-header position-relative d-flex justify-content-center align-items-center">
                <svg class="icon icon-3xl text-white my-4">
                  <use xlink:href="{{asset('node_modules/@coreui/icons/sprites/brand.svg#cib-linkedin')}}"></use>
                </svg>
                <div class="chart-wrapper position-absolute top-0 start-0 w-100 h-100">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="progress-group">
                      <div class="progress-group-header">
                        <svg class="icon icon-lg me-2">
                          <use xlink:href="{{asset('node_modules/@coreui/icons/sprites/brand.svg#cib-facebook-f')}}"></use>
                        </svg>
                        <div>Facebook</div>
